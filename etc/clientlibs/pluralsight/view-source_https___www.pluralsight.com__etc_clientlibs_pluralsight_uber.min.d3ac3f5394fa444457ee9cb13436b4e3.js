...
jQuery("body").on("click","a",function(f){var b=jQuery(this).attr("href");
var g=jQuery(this).hasClass("fancybox");
if(g){f.preventDefault()
}else{if(b.startsWith("#")&&b!=="#"){f.preventDefault();
var e=0;
if(jQuery(b+"_").length){e=jQuery(b+"_").offset().top
}else{if(jQuery(b).length){e=jQuery(b).offset().top
}}var a=0;
...
}}var c=jQuery(".generic-block-wrapper.block--sticky");
if(c.length>0){jQuery("html, body").animate({scrollTop:e-a-c.outerHeight()},200)
}else{jQuery("html, body").animate({scrollTop:e-a},200)
}}}});
...
jQuery(".biz-dropdown").hover(function(){lockBody();
jQuery(".header_nav_courses .header_dropdown").hide();
jQuery(".header_nav_courses .header_nav_primary").removeClass("open");
PS.Components.Objects.SearchResultHeader.hideSearchResultPopup();
...
jQuery(".biz-dropdown .closebutton").click(function(){jQuery(".biz-dropdown--content").fadeOut(300);
jQuery(".biz-dropdown").removeClass("active")
})
});
...
this.searchPagePath=this.$searchButtonComponent.find(".header_search--url").attr("href");
...
if(h==""){h="*"
}window.location.href=f.searchPagePath+"?q="+h
}}else{var m;
if(m){clearTimeout(m)
...
},renderResults:function(c,g){var f='<ul class="header_dropdown--lists">';
for(var e=0;
e<g.length&&e<5;
e++){f+='<li class="header_dropdown--resultInfo">';
f+='<a class="header_dropdown--resultInfoTitle" href="'+this.searchPagePath+"?q="+g[e].replace("-","%20")+'">'+g[e].replace("-"," ")+"</a>";
f+="</li>"
}f+="</ul>";
c.html(f)
...
document.addEventListener("DOMContentLoaded",function(b){var k='a[href*="pluralsight.com/individual/checkout/account-details"], a[href*="pluralsight.com/checkout"], a[href*="pluralsight.com/offer-landing"]',e="undefined"===typeof window.productTestId?null:window.productTestId;
var p=function(){var q=document.querySelectorAll("[data-product-price]");
[].forEach.call(q,function(r){r.style.visibility="visible"
})
};
var j=function(){var q=document.querySelectorAll(k);
[].forEach.call(q,function(r){r.dataset.legacyLink=r.href;
r.href="#";
...
var h=function(){var q=document.querySelectorAll("a[data-legacy-link]");
[].forEach.call(q,function(r){if(r.getAttribute("href")=="#"){r.href=r.dataset.legacyLink
}r.removeAttribute("onclick");
r.removeAttribute("data-legacy-link")
})
};
var g=function(q,s){var r=new XMLHttpRequest();
r.open("GET",q,true);
r.responseType="json";
r.onload=function(){var t=r.status;
if(t===200){s(null,r.response)
}else{s(t,r.response)
}};
r.send()
};
var c=function(r){var q=document.querySelectorAll("[data-product-price]");
[].forEach.call(q,function(t){var s=t.dataset.productPrice;
[].forEach.call(r.products,function(u){[].forEach.call(u.options,function(w){if(w.marketingId===s){var y=function(F){var E=F.display.htmlTemplate;
t.innerHTML=E;
if(t.hasAttribute("data-show-percent")){var C=F.price;
var z=parseFloat(t.getAttribute("data-show-percent"));
var B=(C*z).toFixed(2);
var A=B.toString().split(".")[0];
var D=B.toString().split(".")[1];
t.querySelector(".curr-major").innerText=A;
t.querySelector(".curr-minor").innerText=D
}t.style.visibility="visible"
};
var v=null,x=null;
[].forEach.call(w.pricing,function(z){if(e!=null&&z.testId===e){x=z
}else{if(z.testId===null){v=z
}}});
if(x!=null){y(x)
}else{y(v)
}}})
...
var a=function(t){var r=document.querySelectorAll(k);
var u="https://billing.pluralsight.com/individual/checkout/account-details";
var s="https://billing.pluralsight.com/checkout";
var q="https://billing.pluralsight.com/offer-landing";
if(document.URL.indexOf("-stage.pluralsight")>-1){u="https://billing-stage.pluralsight.com/individual/checkout/account-details";
s="https://billing-stage.pluralsight.com/checkout";
q="https://billing-stage.pluralsight.com/offer-landing"
}[].forEach.call(r,function(x){var y=x.href,v=getParameterByName("sku",y);
if(v!==null){var w=y.substring(y.indexOf("?")+1).split("&");
[].forEach.call(t.products,function(z){[].forEach.call(z.options,function(B){if(B.marketingId===v){var C=function(H){var F=u;
if(y.includes("pluralsight.com/checkout")){F=s
}if(y.includes("pluralsight.com/offer-landing")){F=q
}var G=F+"?requestId="+t.requestId+"&priceOptionId="+H.id+"&legacyTrackingId="+v;
if(w.length>0){for(var E=0;
E<w.length;
E++){if(!w[E].includes("sku=")){G+="&"+w[E]
}}}x.href=G
};
var A=null,D=null;
[].forEach.call(B.pricing,function(E){if(e!=null&&E.testId===e){D=E
...
var n=function(v){var x=document.querySelectorAll("[data-product-annual-savings-percent]"),r="",w="",q="IND-Y-PLUS",s="IND-M-PLUS",t="{{annual-percent-savings}}";
if(x.length){[].forEach.call(v.products,function(y){[].forEach.call(y.options,function(A){if(A.marketingId===q){var z=null,B=null;
[].forEach.call(A.pricing,function(C){if(e!=null&&C.testId===e){B=C
}else{if(C.testId===null){z=C
}}});
if(B!=null){r=B.price
}else{r=z.price
}}if(A.marketingId===s){var z=null,B=null;
[].forEach.call(A.pricing,function(C){if(e!=null&&C.testId===e){B=C
}else{if(C.testId===null){z=C
}}});
if(B!=null){w=B.price
...
if(r!=""&&w!=""){var u=Math.floor(((w-r/12)/w)*100);
[].forEach.call(x,function(y){y.innerHTML=y.innerHTML.replace(t,u);
y.style.visibility="visible"
})
}}};
var m=function(q){window.visitorLocale=q.data.locale;
window.visitorCountry=q.data.country;
c(q.data);
a(q.data);
n(q.data)
};
try{var l=false;
setTimeout(function(){if(!l){dtmEventTrigger("ps.pricingServiceTimeout",{})
}},6000);
if(document.querySelectorAll("[data-product-price]").length||document.querySelectorAll(k).length){var o="https://subscriptions-production.pluralsight.com/catalog/api/v1/localized-products";
if(document.URL.indexOf("-stage.pluralsight")>-1){o="https://subscriptions-staging.pluralsight.com/catalog/api/v1/localized-products"
}if(typeof window.productParamOverride!="undefined"){o=o+window.productParamOverride
}try{j();
g(o,function(q,r){if(q!==null){console.log("Pricing catalog JSON failed: "+q);
dtmEventTrigger("ps.pricingServiceError",{})
}else{var s=r;
if(typeof r=="string"){s=JSON.parse(r)
}h();
m(s);
p();
l=true;
dtmEventTrigger("ps.pricingServiceSuccess",{});
document.addEventListener("at-content-rendering-succeeded",function(){h();
m(s);
p()
},false)
}})
}catch(f){console.log("Placing price data from catalog failed: "+f);
dtmEventTrigger("ps.pricingServiceError",{})
}}else{l=true
}}catch(f){console.log("Pricing catalog parent function failed: "+f);
dtmEventTrigger("ps.pricingServiceError",{})
}});
